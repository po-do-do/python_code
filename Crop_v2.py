...
def on_message(client, userdata, message):
    ...
    if message.payload.decode() == "InitVariables":
        file_path = '/Users/hyeonggeun_kim/Documents/22th_sw_contest/python_code/shared_variables.txt'
        shared_variables = read_variables_from_txt(file_path)
    ...
    if message.payload.decode() == "STOPCOUNT":
        file_path = '/Users/hyeonggeun_kim/Documents/22th_sw_contest/python_code/shared_variables.txt'
        shared_variables = read_variables_from_txt(file_path)
        shared_variables['stop_count']=1
        write_variables_to_txt(file_path,shared_variables)
    
    if message.payload.decode() == "HARVBERRY":
        file_path = '/Users/hyeonggeun_kim/Documents/22th_sw_contest/python_code/shared_variables.txt'
        shared_variables = read_variables_from_txt(file_path)
        ripe_num = shared_variables['total_ripe_count']
        ripe_num = ripe_num - 1
        total_num = shared_variables['total_strawberry_count']
        total_num = total_num - 1
        shared_variables['total_strawberry_count'] = total_num
        shared_variables['total_ripe_count'] = ripe_num
        write_variables_to_txt(file_path,shared_variables)

    if message.payload.decode() == "HARVDISEASED":
        file_path = '/Users/hyeonggeun_kim/Documents/22th_sw_contest/python_code/shared_variables.txt'
        shared_variables = read_variables_from_txt(file_path)
        pest_num = shared_variables['total_pest_count']
        pest_num = pest_num - 1
        shared_variables['total_pest_count'] = pest_num
        total_num = shared_variables['total_strawberry_count']
        total_num = total_num - 1
        shared_variables['total_strawberry_count'] = total_num
        write_variables_to_txt(file_path,shared_variables)
